...
export default function Home(): JSX.Element {
  ...
  return (
    <div className={sans.className}>
      <div className="mb-6 flex flex-col gap-4 rounded-2xl border border-[#e2e4ea] bg-white p-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#b45309]">
            Today&apos;s Board
          </p>
          <h1 className="text-2xl font-bold text-[#14161a]">오늘의 할 일</h1>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-lg bg-[#b45309] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#93440a]"
          >
      ...
      <div className="mb-6 flex flex-col gap-4 rounded-2xl border border-[#e2e4ea] bg-white p-5 sm:flex-row sm:flex-wrap sm:items-end sm:gap-5">
        <div className="flex flex-col gap-1.5">
          <label
            htmlFor="filter-status"
            className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#9aa0b0]"
          >
            상태
          </label>
          <select
            ...
            className="rounded-lg border border-[#e2e4ea] bg-[#f3f4f6] px-3 py-2 text-sm text-[#14161a] outline-none transition focus:border-[#b45309] focus:ring-2 focus:ring-[#b45309]/25"
          >
        ...
        <div className="flex flex-col gap-1.5 sm:ml-auto">
          ...
          <select
            ...
            className={`${mono.className} rounded-lg border border-[#e2e4ea] bg-[#f3f4f6] px-3 py-2 text-sm text-[#14161a] outline-none transition focus:border-[#b45309] focus:ring-2 focus:ring-[#b45309]/25`}
          >
      ...
      {tasksLoading && (
        <div className="rounded-2xl border border-[#e2e4ea] bg-white p-10 text-center text-sm text-[#63697a]">
          불러오는 중...
        </div>
      )}
      ...
      {tasksError && (
        <div
          role="alert"
          className="rounded-2xl border border-[#c0293d]/40 bg-[#fbeaec] p-6 text-sm text-[#c0293d]"
        >
          할 일을 불러오지 못했습니다.
        </div>
      )}
